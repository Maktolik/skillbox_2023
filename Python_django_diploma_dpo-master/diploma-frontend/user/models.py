...
from shop.models import Product, Sales
...
class Profile(models.Model):
    ...
    fullName = models.CharField(max_length=100, blank=True, null=True, default="", verbose_name="полное имя")
    phone = models.CharField(null=True, blank=True, default="", max_length=16, verbose_name="телефон")
    avatar = models.ImageField(verbose_name="аватар", upload_to=profiles_avatars_directory_path, null=True, blank=True)
    city = models.CharField(max_length=40, null=True, blank=True, default="", verbose_name="город")
    address = models.CharField(max_length=80, null=True, blank=True, default="", verbose_name="адрес")
